            ...
            <table class="table text-center" style="width: 100%; border-collapse: collapse">
                ...
                <c:forEach varStatus="i" items="${listHoaDon}" var="hoaDon">
                    <tr>
                        ...
                        <td><fmt:formatDate value="${hoaDon.ngayThanhToan}" pattern="dd/MM/yyyy"/></td>
                        <td>${hoaDon.soLuong}</td>
                        <td><fmt:formatNumber value="${hoaDon.tongTien}" pattern="#,##0.##"/> vnd</td>
                        <td>
                            <a href="/store/chi-tiet-hoa-don?idHD=${hoaDon.id}"><button class="btn btn-primary">Chi tiết</button></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
